'''
Reference implementation of enwalk.
...
def parse_args():
	'''
	Parses the enwalk arguments.
	'''
	parser = argparse.ArgumentParser(description="Run enwalk.")
	...
	parser.add_argument('--p', type=float, default=1, help='Hyperparameter for common time. Default is 0.25')

	parser.add_argument('--q', type=float, default=1, help='Hyperparameter for common followers. Default is 0.25')

	parser.add_argument('--r', type=float, default=1, help='Hyperparameter for common fraud. Default is 0.25')

	parser.add_argument('--s', type=float, default=1, help='Hyperparameter for common celebrity mentioning. Default is 0.25')
...
def main(args):
	...
	'''
	nx_G = read_graph()
	G = enwalk.Graph(nx_G, args.directed, args.p, args.q, args.r, args.s)
